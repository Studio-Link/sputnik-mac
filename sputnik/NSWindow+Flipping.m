...
#define NSWindowFlippingViewAnimationDefaultShadowColor [[NSColor shadowColor] colorWithAlphaComponent: .5]
...
CGFloat const NSWindowFlippingViewAnimationDefaultDuration = 0.5;
CGFloat const NSWindowFlippingViewAnimationDurationOfManualFrames = (NSWindowFlippingViewAnimationDefaultDuration / 60);
...
+ (NSWindow *)flippingContainerWindow
{
    if (!flippingContainerWindow)
    {
        ...
        [flippingContainerWindow setCollectionBehavior: NSWindowCollectionBehaviorCanJoinAllSpaces];
